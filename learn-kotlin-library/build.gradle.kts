...
allprojects {
    ...
    dependencies {
        ...
        // compile("org.jetbrains.kotlinx:kotlinx-coroutines-io:0.24.0")
        ...
        compile("org.jetbrains.kotlinx:kotlinx-io:0.1.0-beta-2")
        ...
        compile("io.arrow-kt:arrow-annotations:$arrowVersion")

        compile("nl.komponents.kovenant:kovenant:$kovenantVersion")

        compile("org.jetbrains.kotlinx:kotlinx-html:$kotlinxHTMLVersion")
        ...
        */
        ...
        testCompile("io.arrow-kt:arrow-effects:$arrowVersion")
    ...
    application {
        mainClassName = "com.greatdreams.learn.kotlin.ktor.ServerKt"
    }
