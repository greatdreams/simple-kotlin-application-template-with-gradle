...
allprojects {
    ...
    dependencies {
        ...
        val reactiveStreamVersion : String by project
        ...
        compile("org.reactivestreams:reactive-streams-examples:$reactiveStreamVersion")
    ...
    application {
        mainClassName = "com.greatdreams.learn.reactor.MainProgram"
    }
